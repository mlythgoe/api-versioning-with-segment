...
public class SegmentVersionControllerTest {
    ...
    @Test
    void hello_WithoutVersionSegment_ShouldReturnDefaultResponse() throws Exception {
    ...
    @Test
    void hello_WithInvalidVersionSegment_ShouldReturnBadRequest() throws Exception {
        ...
        mockMvc.perform(get("/hello/99999")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isBadRequest());
    }
}
